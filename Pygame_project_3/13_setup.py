...
def setup_gemstone():
    small_gold_price, small_gold_speed = 150, 5
    big_gold_price, big_gold_speed = 400, 2
    ...
    gemstone_group.add(Gemstone(gemstone_images[0], (800, 350), small_gold_price, small_gold_speed))
    ...
    gemstone_group.add(Gemstone(gemstone_images[3], (600, 600), diamond_price, diamond_speed))
...
def display_score():
    ...
    screen.blit(txt_curr_score, (50, 70))
...
def display_game_over():
    ...
    rect_game_over = txt_game_over.get_rect(center=(int(screen_width/2), (screen_height/2)))
...
while running:
    ...
    display_time(int(total_time - elapsed_time)) # 시간 표시
